...
% Gradient Descent algorithm with line-search for systems of nonlinear equations
%  function [ x,f ] = gradientDescent( fnon, fjac, x0, tol, maxit )
...
%
% Example: [x,f]=gradientDescent( @example2, @fdJacobian, [1; 1], 1e-8, 40 )
% compare: [x,f] = gradientDescent( @example2, @fdJacobian, [1; 1], 1e-8, 40 )
